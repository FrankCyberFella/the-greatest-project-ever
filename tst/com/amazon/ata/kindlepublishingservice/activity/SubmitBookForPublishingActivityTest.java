...
public class SubmitBookForPublishingActivityTest {
    ...
    @Test
    public void execute_invalidBookIdInRequest_throwsException() {
        SubmitBookForPublishingRequest request = SubmitBookForPublishingRequest.builder()
                .withAuthor("Author")
                .withTitle("Title")
                .withBookId("book.123")
        ...
        doThrow(new BookNotFoundException("Invalid bookId")).when(catalogDao).validateBookExists(request.getBookId());
